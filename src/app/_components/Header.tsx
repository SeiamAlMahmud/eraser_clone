    ...
    <div className="flex flex-1 items-center justify-end md:justify-between">
      ...
      <div className="flex items-center gap-4">
        <div className="sm:flex sm:gap-4">
          <a
            className="block rounded-md bg-black-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-gray-700"
            href="#"
          >
            Login
          </a>
          ...
          <a
            className="hidden rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-black transition hover:bg-gray-800 hover:text-white sm:block hover:border-purple-500 hover:border-[1px]"
            href="#"
          >
            Register
          </a>
